...
export function Login(){
    ...
    return(
        <div className="flex flex-col items-center justify-center gap-5 py-10">
            <img src="./Group.png" alt="" className="h-auto w-[40%]"/>
            <div className="w-full h-1/2 text-center" >
                ...
                <form  onSubmit={handleSubmit} className="flex flex-col gap-5 px-5 mt-5">
                    ...
                    <div>
                        ...
                        <Link to={'/cadastro'} className="mt-2 font-medium cursor-pointer hover:underline">Não tem conta? <span className="text-[#115830]">Cadastre-se!</span></Link>
                    </div>
                </form>
            </div>
        </div>
